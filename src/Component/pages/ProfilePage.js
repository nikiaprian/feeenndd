...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get("http://43.218.14.145:9090/user/profile", {
          headers: {
    ...
    fetchBlogs("http://43.218.14.145:9090/blogs", token);
    fetchForums("http://43.218.14.145:9090/forums", token);
    fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch("http://43.218.14.145:9090/user/update-profile", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
