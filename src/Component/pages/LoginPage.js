...
const LoginPage = () => {
  const baseUrl = "http://43.218.14.145:9090/auth/login";
      ...
      <div className="overflow-x-hidden flex py-44 items-center flex-col-reverse justify-center gap-10 w-full md:gap-x-80  lg:flex-row">
        ...
        <div className=" border-slate-200 rounded-xl  shadow-md p-12 w-96 sm:w-86 h-auto">
          ...
          <Link to="/auth/google/callback">
            <button onClick={() => (window.location = "http://43.218.14.145:9090/auth/login/google")} className="py-3 px-3 mt-8 mb-4 w-full justify-center rounded-2xl bg-blue-50 hover:bg-blue-100 focus:bg-blue-100 active:bg-blue-200 flex">
