...
const storeBlog = (set) => ({
  ...
  fetchSetComment: async (id) => {
    await axios
      .get(`http://43.218.14.145:9090/comments/${id}`, {
        headers: {
          "Content-Type": "application/json",
        },
      })
  ...
  fetchCommentInput: async (id, data, token) => {
    await axios
      .post(`http://43.218.14.145:9090/comments/${id}`, data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
...
const storeForum = (set) => ({
  ...
  fetchForums: async (token) => {
    await axios
      .get("http://43.218.14.145:9090/forums", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  fetchsetAnswer: async (id, key) => {
    await axios
      .get(`http://43.218.14.145:9090/commentsforum/${id}`, {
        headers: {
          "Content-Type": "application/json",
  ...
  fetchAnswerInput: async (id, data, token) => {
    await axios
      .post(`http://43.218.14.145:9090/commentsforum/${id}`, data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
